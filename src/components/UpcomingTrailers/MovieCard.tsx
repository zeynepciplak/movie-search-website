    ...
    <>
      <StyledCard onClick={handleClickOpen}>
        {loading ? (
          ...
          <StyledCardMedia src={`https://img.youtube.com/vi/${videoId}/hqdefault.jpg`} alt={title} />
        )}
        ...
        <StyledButton onClick={handleClickOpen}>{t('UpComing.Watch Trailer')}</StyledButton>
      </StyledCard>
